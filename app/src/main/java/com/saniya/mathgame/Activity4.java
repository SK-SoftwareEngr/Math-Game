...
public class Activity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GameContinue();
        gameFunc.startTimer(tvTime, tvQuestion, tvLife, score, Activity4.this);
        ...
        btnSubmit.setOnClickListener(v -> {
            ...
            if (uI.isEmpty())
            {Toast.makeText(Activity4.this, "Please enter a valid answer", Toast.LENGTH_LONG).show();}
            else{
                if(userInput == answer){
                    ...
                    if(life == 0){
                        gameFunc.lifeZero(tvQuestion, Activity4.this, score);
                        finish();
                    }
                    else{
                        GameContinue();
