...
public class Activity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GameContinue();
        gameFunc.startTimer(tvTime, tvQuestion, tvLife, score, Activity3.this);
        ...
        btnSubmit.setOnClickListener(v -> {
            ...
            if (uI.isEmpty())
            {Toast.makeText(Activity3.this, "Please enter a valid answer", Toast.LENGTH_LONG).show();}
            else{
                if(userInput == answer){
                    ...
                    if(life == 0){
                        gameFunc.lifeZero(tvQuestion, Activity3.this, score);
                        finish();
                    }
                    else{
                        GameContinue();
