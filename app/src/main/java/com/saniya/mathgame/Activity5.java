...
public class Activity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GameContinue();
        gameFunc.startTimer(tvTime, tvQuestion, tvLife, score, Activity5.this);
        ...
        btnSubmit.setOnClickListener(v -> {
            ...
            if (uI.isEmpty())
            {Toast.makeText(Activity5.this, "Please enter a valid answer", Toast.LENGTH_LONG).show();}
            else{
                if(userInput == answer){
                    ...
                    if(life == 0){
                        gameFunc.lifeZero(tvQuestion, Activity5.this, score);
                        finish();
                    }
                    else{
                        GameContinue();
    ...
    private void GameContinue() {
        num2 = random.nextInt(10) + 1; // Ensure denominator is never a zero
        num1 = num2 * (random.nextInt(10) + 1); // generates random multiple of num1
        answer = num1 / num2;
